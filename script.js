...
const winterMonths = [
    {
        ...
        story: "Именно в декабре ты появилась в моей жизни. Помнишь тот вечер, когда пошёл первый снег? Ты сказала, что снежинки похожи на звёзды, которые спустились с неба, чтобы поприветствовать нас. Я смотрел на твои ресницы, покрытые инеем, и думал: «Это самое красивое, что я видел за всю зиму». А потом понял, что зима только начинается.",
        memory: "Наша первая прогулка по вечернему городу, когда ты пыталась поймать снежинки ртом.",
